...
export type TicketsReducerType = ItemsHasErroredType | ItemsIsLoadingType | ItemsFetchDataSuccessType
...
export const itemsFetchDataSuccess = (value: TicketsType[]) => ({ type: actionTypes.ITEMS_FETCH_DATA_SUCCESS, value })
